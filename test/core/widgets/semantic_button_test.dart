...
void main() {
  group('SemanticButton', () {
    ...
    testWidgets('when a semanticLabel is provided, child semantics are excluded',
        (tester) async {
      final handle = tester.ensureSemantics();
      await tester.pumpWidget(
        _wrap(
      ...
      final data =
          tester.getSemantics(find.byType(SemanticButton)).getSemanticsData();
    ...
    testWidgets('semanticHint is applied to the semantic node',
        (tester) async {
      final handle = tester.ensureSemantics();
      await tester.pumpWidget(
        _wrap(
